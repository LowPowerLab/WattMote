/*
#  WattMote project based on Moteino, optional TMP36 temperature sensor, and RaspberryPi
#  Writeup and guide: http://lowpowerlab.com/blog/2012/12/28/wattmote-moteino-based-wireless-killawatt/
#
